...
// Jerry
function Jerry(game, startingPosition, speed, dirTime, spriteSheet) {
    this.frameWidth = 32;
    this.frameHeight = 32;
    this.sheetWidth = 4;
...
// Enemy Follower
function Enemy(game, startingPosition, frameWidth, frameHeight, speed, dirTime, spriteSheet) {
    // spriteSheet, frameRow, frameCol, frameWidth, frameHeight, sheetWidth, frameDuration, frames, loop, scale
...
// Healer
function Healer(game, startingPosition, frameWidth, frameHeight, speed, dirTime, spriteSheet) {
    // spriteSheet, frameRow, frameCol, frameWidth, frameHeight, sheetWidth, frameDuration, frames, loop, scale
    this.frameWidth = frameWidth;
    this.frameHeight = frameHeight;
    this.sheetWidth = 2;
...
////////// Loading in images //////////
AM.queueDownload("./Homework2/img/JerryWalk.png");
AM.queueDownload("./Homework2/img/background.png");
AM.queueDownload("./Homework2/img/TestCharacter.png");
AM.queueDownload("./Homework2/img/DinoEnemy.png");
AM.queueDownload("./Homework2/img/SnowmanEnemy.png");
AM.queueDownload("./Homework2/img/DuckEnemy.png");
AM.queueDownload("./Homework2/img/BulletCannon.png");
...
AM.downloadAll(function () {
    ...
    gameEngine.addEntity(new Background(gameEngine, AM.getAsset("./Homework2/img/background.png")));
    gameEngine.addEntity(new Jerry(gameEngine, {x: 640, y: 360}, HUMAN_SPEED, 2.5, AM.getAsset("./Homework2/img/JerryWalk.png")));
    gameEngine.addEntity(new Enemy(gameEngine, {x: 200, y: 500}, 37, 56, ENEMY_SPEED, 3, AM.getAsset("./Homework2/img/DinoEnemy.png")));
    gameEngine.addEntity(new Enemy(gameEngine, {x: 1000, y: 100}, 42, 42, ENEMY_SPEED, 2.5, AM.getAsset("./Homework2/img/SnowmanEnemy.png")));
    gameEngine.addEntity(new Enemy(gameEngine, {x: 1000, y: 600}, 47, 37, ENEMY_SPEED, 1.5, AM.getAsset("./Homework2/img/DuckEnemy.png")));
    gameEngine.addEntity(new Healer(gameEngine, {x: 100, y: 100}, 16, 21, HUMAN_SPEED, 2, AM.getAsset("./Homework2/img/TestCharacter.png")));
    gameEngine.addEntity(new Healer(gameEngine, {x: 640, y: 100}, 19, 19, HEALER_SPEED, 2.5, AM.getAsset("./Homework2/img/BulletCannon.png")));
    gameEngine.addEntity(new Healer(gameEngine, {x: 640, y: 100}, 19, 19, HEALER_SPEED, 2.5, AM.getAsset("./Homework2/img/BulletCannon.png")));
    gameEngine.addEntity(new Healer(gameEngine, {x: 640, y: 100}, 19, 19, HEALER_SPEED, 2.5, AM.getAsset("./Homework2/img/BulletCannon.png")));
